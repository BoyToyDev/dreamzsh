...
Вместо копирования стороннего кода запись каталога может ссылаться на исходный
...
DreamZSH клонирует, проверяет и обновляет исходный код, а официальный каталог
предоставляет проверенные метаданные и документацию.
...
зависимостей, registry, обновления и удаления с локальными Git-репозиториями,
тесты установщика, синтаксическая проверка Zsh и Linux CI. Изменения конфигурации
и обновления ресурсов не должны оставлять систему в частично изменённом состоянии.
...
- Расширение официального каталога после autosuggestions, syntax highlighting
  и инструментов kubectl.
- Улучшение диагностики зависимостей и переносимости профилей.
- Новые темы и документация по созданию расширений.
- Необязательный lazy loading после проработки формата метаданных.
